	...
	*/
	...
	public void startProxy() {
		if (proxy == null) {
			try {
				...
				proxy = new SyncProxyALM(this, "Glass Stuff", "Glass", new Vector<String>(0), Boolean.FALSE, version, Language.EN_US, Language.EN_US, "WERASDGE", null);
	...
	public void onProxyClosed(String info, Exception e, SyncDisconnectedReason reason) {
		...
		if ((((SyncException) e).getSyncExceptionCause() != SyncExceptionCause.SYNC_PROXY_CYCLED))
		{
			...
			{
				Log.v(Drive.TAG, "reset proxy in onproxy closed");
				reset();
			}
		}
	}
	...
	public void onOnHMIStatus(OnHMIStatus notification) {
		...
		switch(notification.getHmiLevel()) {
			case HMI_FULL:
				...
				break;
			case HMI_LIMITED:
				Log.i(Drive.TAG, "HMI_LIMITED");
				break;
			case HMI_BACKGROUND:
				Log.i(Drive.TAG, "HMI_BACKGROUND");
				break;
			case HMI_NONE:
				Log.i(Drive.TAG, "HMI_NONE");
				break;
			default:
				return;
		}
